...
\documentclass[oneside,12pt]{Classes/uitBA}
 ...
 \fi
  ...
  \title{NGHIÊN CỨU HỆ THỐNG MOODLE KẾT HỢP CÔNG NGHỆ HTML5 ỨNG DỤNG TRONG VIỆC HỌC LUYỆN NGHE MÔN TIẾNG ANH TRÊN MÁY TÍNH BẢNG} 
  \crest{\includegraphics[scale=.20]{UITLogo}} 
